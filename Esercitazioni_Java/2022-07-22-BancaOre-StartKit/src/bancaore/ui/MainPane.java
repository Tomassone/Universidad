...
public class MainPane extends BorderPane {
	...
	public MainPane(Controller controller) {
		...
		listView.setItems(FXCollections.observableArrayList(controller.getVociBancaOre()));
		listView.getSelectionModel().selectedItemProperty().addListener(
				(obj, oldval, newval) -> output.setText(listView.getSelectionModel().getSelectedItem().toString()));		
